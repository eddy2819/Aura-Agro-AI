...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final role = Provider.of<DataProvider>(context).profile?['role'] ?? 'Ganadero';
    return Scaffold(
      ...
      body: Consumer<DataProvider>(
        builder: (context, provider, child) {
          ...
          if (role == 'Veterinario') {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: AppTextStyles.body.copyWith(color: Colors.white.withOpacity(0.9), fontSize: 13),
                  ),
                ],
              ),
            ));
            ...
            // Ganadero / default
            content.add(Text(
              '$farmName está funcionando bien',
              style: AppTextStyles.body,
            ));
            content.add(const SizedBox(height: 16));
