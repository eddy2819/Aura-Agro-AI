-- Bucket privado para fotografías usadas por el registro y análisis de ganado.
...
-- La app guarda en: animals/<auth.uid()>/<archivo>.
...
create policy "animal_photos_insert_own"
...
create policy "animal_photos_update_own"
...
create policy "animal_photos_delete_own"
